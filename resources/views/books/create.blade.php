    ...
    <div class="container mx-auto py-6 px-4">
        ...
        <form action="{{ route('books.store') }}" method="POST" class="bg-gray-800 p-6 rounded shadow">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="type" id="type" required class="mt-1 block w-full py-2 px-3 border border-gray-700 bg-gray-900 text-black rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
            </div>
